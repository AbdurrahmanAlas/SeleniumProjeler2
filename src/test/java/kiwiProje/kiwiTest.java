...
@Test
    public void kiwiTesst() throws InterruptedException {

    // https://www.kiwi.com sayfasina gidin
        driver.get("https://www.kiwi.com");
    // Cookies i reddedin

    WebElement cookies=driver.findElement(By.id("cookies_accept"));
    cookies.click();
    ...
    WebElement dilpara=driver.findElement(By.xpath("//*[text()=\"TRY\"]"));
    dilpara.click();

    WebElement selectWebElementi=driver.findElement(By.xpath("//select[@data-test=\"LanguageSelect\"]"));
    Select select=new Select(selectWebElementi);
    ...
    select1.selectByValue("Turkish lira - TRY");
